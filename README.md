...
| [**Remio**](https://remio.ai/) | Local-first AI memory and knowledge base desktop app for searching personal files, webpages, recordings, emails, messages, and images with local indexes and vector retrieval. | See website | See website |
